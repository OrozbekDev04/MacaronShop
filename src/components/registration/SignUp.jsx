...
import { registerUser } from '../../redux/slice.js';
...
const SignUp = () => {
    ...
    return (
        <div className="w-[900px] h-[740px] bg-[#F7EBE5] my-[80px] mx-auto">
            ...
            <div className="px-[80px]">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <button type="submit"
                            className="w-full h-[50px] bg-blue-700 text-[16px] font-medium text-[#FFFFFF] mt-[30px] mb-[15px]">
